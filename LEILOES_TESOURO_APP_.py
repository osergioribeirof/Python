{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyMTaAFPnS9VNm1bloG7SBYA",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "tTGJ0bcqOtl9",
        "outputId": "04b5cd69-0ba3-4e00-cfad-6c69065911f5"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        ...
        "import Selic_Resultado_Dos_Leilões  # Importa seu código Python\n",
        "\n",
        "# Título da aplicação\n",
        ...
        "    resultado = Selic_Resultado_Dos_Leilões.funcao_principal()  # Chame a função do seu código\n",
