...
if response.status_code == 200:
    ...
    coluna_selecionada = st.selectbox("Selecione o tipo de investidor:", colunas)
    ...
    fig = px.line(
        ...
        title=f"Fluxo de Investidores - {coluna_selecionada}",
        labels={'Data': 'Data', coluna_selecionada: 'Valor (R$ mi)'}
    )
